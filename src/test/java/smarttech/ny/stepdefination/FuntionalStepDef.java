...
public void verify_that_home_page_is_visible_successfully() {
    ...
    String text = pf.getVerifyHomepage().getText();
 	Assert.assertEquals("Home", text); //expected, actual
 	
 	
	//String expected = "Home";  //BA requirement
	//String actual = pf.getClickOnLoginBTN().getText();
  
	//String actual = driver.findElement(By.xpath("//*[text()=' Home']")).getText();
	//System.out.println("Expected Value Is : " + actual);
	
	//String text = driver.findElement(By.xpath("//*[text()=' Home'")).getText();  //check visibility of Home link
	//System.out.println("Visibility of HOME link "+text); 
	
    
}
@When("Users Able To Click On Products Module")
public void users_able_to_click_on_products_module() {
    CommonUtil.actionClick(pf.getClickOnProducts());
